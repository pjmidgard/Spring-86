...
image_no_2 = ImageTk.PhotoImage(Image.open("smaple1.jfif"))
image_no_3 = ImageTk.PhotoImage(Image.open("smaple1.jfif"))
image_no_4 = ImageTk.PhotoImage(Image.open("smaple1.jfif"))
